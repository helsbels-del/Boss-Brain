...
def instructions():
    ...
    print("(\n) * 2")
    print("\033[4;96mBonus Challenge Game \033[0;96m\n")
    print(" The computer generates a code word from a bank of code words in its memory.")
    print(" The player must guess each letter at a time to crack the code word.")
    print(" The player is told how many letters are in the word and the amount of attempts they have.")
    print(" If the player cracks the code word before runnning out of attempts, this is the end of the game.")
    print(" The player then has the choice to play again or return to the main page.\n")
    print(" If the player runs out of attempts before cracking the code word, this is the end of the game.")
    print(" The player then has the choice to play again, or return to the main page.\n")
    print(" If the player enters an incorrect letter or anything other than a letter,")
    print(" a message will appear to tell the player that they have entered something incorrectly and to check their guess.")
    print(" This does not count as an attempt and the player will have the same remaining number of attempts as before they made the incorrect guess.\n")
    print(" If the player enters a letter that they have already entered, and it is not in the code word multiple times,")
    print(" a message will appear to tell the player that they have already entered this letter and to try again.")
    print(" This does not count as an attempt and the player will have the same remaining number of attempts as before they made the incorrect guess.\n")
    print("(\n) * 2")
