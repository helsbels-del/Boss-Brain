...
def instructions():
    ...
    """
    clear_screen()
    print("\033[1;96m INSTRUCTIONS FOR PLAY\n")
    print(" Main Game")
    ...
    print("\033[1;96m Bonus Challenge Game \033[0;96m\n")
...
def play_game(max_attempts, level):
    ...
    print(" \033[1;92m  Remember, the colours can appear multiple times!")
    print("   And don't forget to put a space between each letter.")
    print("   Enter the first letter of each colour only.\n")
...
# while loop to itereate over game until max attempts made
    ...
    while attempts < max_attempts:
        answer = input(f"\033[1;32m Attempt {attempts + 1}/{max_attempts}. Enter your 4 letter guess\033[31;1m('R',\033[34;1m'B',\033[32;1m'G',\033[33;1m'Y',\033[37;1m'W',\033[35;1m'P'):\033[0;37m \n").upper().strip().split()
        ...
        print(f"\033[33;1m{correct_position} \033[37;1m colour(s) in the correct place!")
        print(f"\033[33;1m{correct_color} \033[37;1m correct colour(s) but in the wrong place!\n")
